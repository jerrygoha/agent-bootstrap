...
Do not add backward compatibility without explicit approval from Partner.

You may spawn sub-agents for independent work when Partner's standing preference or the lead's direction allows it and the task can be split cleanly.
